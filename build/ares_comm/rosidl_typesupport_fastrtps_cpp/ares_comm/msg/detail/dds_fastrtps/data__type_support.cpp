...
#include "ares_comm/msg/detail/data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ares_comm::msg::Data & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: data_id
  cdr << ros_message.data_id;
  // Member: data
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ares_comm::msg::Data & ros_message)
{
  // Member: data_id
  cdr >> ros_message.data_id;
  ...
  size_t current_alignment)
{
  ...
  // Member: data_id
  {
    size_t item_size = sizeof(ros_message.data_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ares_comm::msg::Data;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ares_comm::msg::Data *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ares_comm::msg::Data *>(
    untyped_ros_message);
...
{
  return &ares_comm::msg::typesupport_fastrtps_cpp::_Data__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ares_comm, msg, Data)() {
  return &ares_comm::msg::typesupport_fastrtps_cpp::_Data__handle;
}
