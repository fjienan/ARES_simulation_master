...
bool ares_comm__msg__data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ares_comm.msg._data.Data", full_classname_dest, 24) == 0);
  }
  ares_comm__msg__Data * ros_message = _ros_message;
  {  // data_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "data_id");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->data_id = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // data
...
PyObject * ares_comm__msg__data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ares_comm.msg._data");
  ...
  {  // data_id
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->data_id);
    {
      int rc = PyObject_SetAttrString(_pymessage, "data_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
