...
{
  new (message_memory) ares_comm::msg::Error(_init);
}

void Error_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ares_comm::msg::Error *>(message_memory);
  typed_message->~Error();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Error_message_member_array[2] = {
  {
    ...
    offsetof(ares_comm::msg::Error, request_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ares_comm::msg::Error, error_code),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::ares_comm::msg::rosidl_typesupport_introspection_cpp::Error_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ares_comm, msg, Error)() {
  return &::ares_comm::msg::rosidl_typesupport_introspection_cpp::Error_message_type_support_handle;
}
