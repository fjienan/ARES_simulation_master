...
#ifndef ARES_COMM__SRV__DETAIL__EXECUTE__FUNCTIONS_H_
#define ARES_COMM__SRV__DETAIL__EXECUTE__FUNCTIONS_H_
...
#include "ares_comm/msg/rosidl_generator_c__visibility_control.h"

#include "ares_comm/srv/detail/execute__struct.h"

/// Initialize srv/Execute message.
/**
...
/// Create srv/Execute message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ares_comm__srv__Execute_Request__init().
...
/// Destroy srv/Execute message.
/**
 * It calls
 * ares_comm__srv__Execute_Request__fini()
...
/// Check for srv/Execute message equality.
/**
...
/// Initialize array of srv/Execute messages.
/**
...
/// Finalize array of srv/Execute messages.
/**
 * It calls
 * ares_comm__srv__Execute_Request__fini()
...
/// Create array of srv/Execute messages.
/**
 * It allocates the memory for the array and calls
 * ares_comm__srv__Execute_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Execute messages.
/**
 * It calls
 * ares_comm__srv__Execute_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Execute message array equality.
/**
...
/// Copy an array of srv/Execute messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ares_comm__srv__Execute_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ares_comm
...
/**
 * It calls
 * ares_comm__srv__Execute_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ares_comm
...
/**
 * It allocates the memory for the array and calls
 * ares_comm__srv__Execute_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ares_comm
...
/**
 * It calls
 * ares_comm__srv__Execute_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ARES_COMM__SRV__DETAIL__EXECUTE__FUNCTIONS_H_
